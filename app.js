...
function bindUI(){
  ...
  $("#checkoutBtn").onclick=()=>{if(!cart.length)return toast("سبد خرید خالی است");$("#checkoutModal").classList.add("open");renderDeliveryOptions();renderCheckoutSummary();bindPhoneValidation()};
...
async function submitOrder(e){
 ...
 location.href="invoice.html?order="+encodeURIComponent(data.order_number);
}
