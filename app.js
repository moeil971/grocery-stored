...
function bindUI(){
  ...
  document.querySelectorAll(".pill").forEach(b=>b.onclick=()=>{document.querySelectorAll(".pill").forEach(x=>x.classList.remove("active"));b.classList.add("active");activeFilter=b.dataset.filter;visibleProductCount=15;renderProducts()});
  ...
  $("#showMoreProducts").onclick=()=>{activeFilter="all";activeCategory="";visibleProductCount=15;document.querySelectorAll(".pill").forEach(x=>x.classList.remove("active"));document.querySelector('.pill[data-filter="all"]').classList.add("active");renderProducts();window.scrollTo({top:document.querySelector("#products").offsetTop-80,behavior:"smooth"})};
...
function renderCategoryChips(){
  ...
  document.querySelectorAll("[data-cat]").forEach(b=>b.onclick=()=>{activeCategory=b.dataset.cat;renderCategoryChips();visibleProductCount=15;renderProducts();$("#categorySheet").classList.remove("open");window.scrollTo({top:0,behavior:"smooth"})});
  document.querySelectorAll("[data-bottom-cat]").forEach(b=>b.onclick=()=>{activeCategory=b.dataset.bottomCat;renderCategoryChips();visibleProductCount=15;renderProducts();window.scrollTo({top:document.querySelector("#products").offsetTop-70,behavior:"smooth"})});
}
