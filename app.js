...
function bindUI(){
  ...
  popularBtn?.addEventListener("click",()=>{
    // پرفروش‌ها مستقل از دسته‌بندی است و مستقیماً از تیک is_popular محصولات خوانده می‌شود.
    activeFilter="popular";activeCategory="";visibleProductCount=15;setProductsView("popular");renderCategoryChips();renderProducts();
  });
