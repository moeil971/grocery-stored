...
const authEmail=phone=>`${normalizePhone(phone)}@accounts.moeili.local`;
...
function bindUI(){
  ...
  $("#navOrders").onclick=()=>{closeAllSheets();openAccountSheet("برای دیدن سفارش‌ها وارد حساب خود شوید.");setTimeout(()=>document.querySelector("#myOrders")?.scrollIntoView({behavior:"smooth"}),250)};
